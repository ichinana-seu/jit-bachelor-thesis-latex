...
\documentclass{jitthesis-2026}

\title{你的杰作}{（此栏可删除）}
\titleEN{Your masterpiece The development of Environment for NC Simulation }{ (shall be deleted)}
\author{作者名}
\studentnum{114514}
\department{哈基米学院}
\major{原神专业}
\supervisor{孔子}
\periodsubmit{2022年10月1日}
\perioddefense{2026年3月1日}
\class{3班}
...
\begin{abstractCN}
  ...
  论文名要求：小二号黑体居中，与“摘要”空一行。“摘”“要”两个字之间空一格，居中三号黑体)摘要内容：小四号楷体，1.5倍行距

  
  “摘要”用三号黑体加粗居中，“摘”与“要”之间空4个半角空格。摘要正文内容用小四号宋体，固定1.5倍行距。
  
  【东南大学】论文的关键词是反映毕业设计（论文）主题内容的名词，一般为3-5个，排在摘要正文部分下方。关键词与摘要之间空一行。中文关键词之间用逗号分开，最后一个关键词后不加标点符号。该模版会自动分割关键词，不要动那个英文逗号。
  
  【金陵科技学院】要求，“关键词”顶格、四号黑体。“关键词1;关键词2;关键词3;关键词4”使用小四号楷体。
...
\begin{abstractEN}
  ...
  \keywordsEN{Keywords1,Keywords2,Keywords3,Keywords4}
\end{abstractEN}
...
\lastmatter
\nocite{*} % 把.bib所有文献全部加入参考文献列表，不管正文里有没有用 \cite{} 引用过。
\bibliographystyle{gbt7714-numerical}
\bibliography{reference.bib}


\appendixmatter     % 继续阿拉伯页码 + 章节编号 + append版页眉。
\appendix
\chapter{附录名称}
